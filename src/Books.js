...
function Books() {
  ...
  const handleInsert = async () => {
    const { book_id, author, name, stock, price, genre } = newBook;
    if (!book_id || !author || !name || !stock || !price || !genre) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setNewBook({ book_id: '', author: '', name: '', stock: '', price: '', genre: '' });
        setBooks(prev => [...prev, {
          ...newBook,
          id: book_id,
          title: name,
    ...
    <div className="App">
      ...
      <div className="list-item-box">
        ...
        <div className="item-details">
          {['book_id', 'author', 'name', 'stock', 'price', 'genre'].map(field => (
